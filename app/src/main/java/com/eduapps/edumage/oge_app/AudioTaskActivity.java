...
public class AudioTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        switch(category) {
            case 0:
                builder.setMessage("Вы услышите четыре коротких диалога, обозначенных буквами " +
                ...
                break;
            case 1:
                builder.setMessage("Вы услышите пять высказываний, обозначенных буквами " +
                ...
                break;
            case 2:
                builder.setMessage("Вы услышите разговор двух собеседников. В заданиях 3-8 выберите" +
                        " ответ, соответствующий содержанию беседы");
                break;
        }
